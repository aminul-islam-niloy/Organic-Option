    ...
    public class HomeController : Controller
    {
      ...
      //  without Local Shop
       ...
       //  GET: Customer/Home/Products
        ...
        //[Authorize]
        //[HttpPost]
        //public async Task<IActionResult> Products(int? page, int productTypeId, string searchString, decimal? lowAmount, decimal? largeAmount, string sortOrder, int range = 100)
        //{
        //    // Remove cached products to ensure fresh results are fetched
        //    _cache.Remove("AllProducts");
